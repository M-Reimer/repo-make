...
This is where the finished packages are placed to. The default is F<./repo>. This variable can only be set in F<repo-make-custom.conf> and F</etc/repo-make.conf>!
